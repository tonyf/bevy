...
|scene|Features used to compose Bevy scenes. **Feature set:** `bevy_world_serialization`, `bevy_scene`, `bsn_asset`.|
...
|bsn_asset|Provides the `.bsn` scene asset format and its asset loader|
